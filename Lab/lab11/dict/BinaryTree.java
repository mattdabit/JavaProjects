...
public class BinaryTree implements Dictionary {
  ...
  public Entry remove(Object key) {
    if (findHelper((Comparable) key, root) == null){
      return null;
    } else {

      Entry removed = new Entry();
      if (findHelper((Comparable) key, root).leftChild == null && findHelper((Comparable) (Comparable) key, root).rightChild == null){
        removed = findHelper((Comparable) key, root).entry;
        findHelper((Comparable) key, root).entry = null;
        return removed;
      } else if (findHelper((Comparable) key, root).rightChild != null && findHelper((Comparable) key, root).leftChild == null){
        findHelper((Comparable) key, root).entry.key = findHelper((Comparable) key, root).rightChild.entry.key();
        removed = findHelper((Comparable) key, root).entry;
        findHelper((Comparable) key, root).entry = findHelper((Comparable) key, root).rightChild.entry;
        return removed;
      } else if(findHelper((Comparable) key, root).rightChild == null && findHelper((Comparable) key, root).leftChild != null){
        findHelper((Comparable) key, root).entry.key = findHelper((Comparable) key, root).leftChild.entry.key();
        removed = findHelper((Comparable) key, root).entry;
        findHelper((Comparable) key, root).entry = findHelper((Comparable) key, root).leftChild.entry;
        return removed;
      /*} else if (findHelper(key, node).rightChild != null && findHelper(key, node).leftChild != null) {
