...
public class SList {
  ...
  public static void main (String[] args) {
    SList pt1 = new SList();
    pt1.insertFront(new Integer(12));
    pt1.insertFront(new Integer(9));
    pt1.insertFront(new Integer(6));
    System.out.println(pt1);
    pt1.insertFront(new Integer(3));
    pt1.insertEnd(new Integer(15));
    System.out.println(pt1);
    testEmpty();
